 <div class="row">
                <div class="col-lg-12">
                    ...
                    <dt>Gunakan form ini untuk melakukan input data Komputer</dt>
                    <br>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                             ...
                             <form class="form-horizontal" role="form" action="<?=base_url()?>manajer_pc/create" method="post">
                             ...
                             <div class = "row">
                                <div class = "col-md-5">
                                    <input class="form-control" placeholder="Contoh : PC Admin" type="text" name = "txt_keterangan">
                                </div>
                             </div>
                             <br>  
                             ...
                             <div class = "row">
                                <div class = "col-md-5">
                                    <input class="form-control" placeholder="Contoh : 192.168.xxx.xxx" type="text" name = "txt_ip">
                                </div>
                             </div>
                             <br>  
