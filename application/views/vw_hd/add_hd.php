<div class="row">
                <div class="col-lg-12">
                    ...
                    <dt>Gunakan form ini untuk melakukan input data perangkat IT</dt>
                    <br>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            Input Data Perangkat IT
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" action="<?=base_url()?>manajer_perangkat/create" method="post">
                             ...
                             <div class = "row">
                                <div class = "col-md-5">
                                    ...
                                    <input class="form-control" placeholder="Contoh : Mikrotik Router" type="text" name = "txt_nama">
                                </div>
                             </div>
                             <br>   
